...
func (impl *networkImpl) init(address string) {
...
func (impl *networkImpl) setSocket(socket *net.UDPConn, err error) {
...
func (impl *networkImpl) listeningWorker() {
...
func (impl *networkImpl) handlePacket(addr *net.UDPAddr, packet []byte) {
	hash := addrHash(addr)
...
func (impl *networkImpl) connectClient(addr *net.UDPAddr, data []byte) *Connection {
...
func (impl *networkImpl) disconnectClient(connection *Connection, disconnectType disconnectType, packet []byte) {
